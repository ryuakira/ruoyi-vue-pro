...
CREATE TABLE IF NOT EXISTS "system_company" (
                                                ...
                                                "bank_code1" varchar,
                                                "branch1" varchar,
                                                "branch_code1" varchar,
                                                "swift1" varchar,
                                                "account_type1" varchar,
                                                "account_number1" varchar,
                                                "account_name1" varchar,
                                                "currency1" varchar,
                                                "bank2" varchar,
                                                "bank_code2" varchar,
                                                "branch2" varchar,
                                                "branch_code2" varchar,
                                                "swift2" varchar,
                                                "account_type2" varchar,
                                                "account_number2" varchar,
                                                "account_name2" varchar,
                                                "currency2" varchar,
                                                "bank3" varchar,
                                                "bank_code3" varchar,
                                                "branch3" varchar,
                                                "branch_code3" varchar,
                                                "swift3" varchar,
                                                "account_type3" varchar,
                                                "account_number3" varchar,
                                                "account_name3" varchar,
                                                "currency3" varchar,
                                                "bank4" varchar,
                                                "bank_code4" varchar,
                                                "branch4" varchar,
                                                "branch_code4" varchar,
                                                "swift4" varchar,
                                                "account_type4" varchar,
                                                "account_number4" varchar,
                                                "account_name4" varchar,
                                                "currency4" varchar,
                                                "url1" varchar,
                                                "url2" varchar,
                                                "url3" varchar,
...
CREATE TABLE IF NOT EXISTS "system_tecreas_employee" (
     "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
     "employee_num" varchar NOT NULL,
     "employee_name" varchar NOT NULL,
     "employee_name_kana" varchar NOT NULL,
     "avatar" varchar NOT NULL,
     "sex" int NOT NULL,
     "birthday" datetime NOT NULL,
     "residece_card_id" varchar NOT NULL,
     "residece_card_copy" varchar NOT NULL,
     "mynumber_card_id" varchar,
     "emply_cntrct_numbr" varchar,
...
CREATE TABLE IF NOT EXISTS "system_tecreas_worktime" (
     "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
     "employee_num" varchar NOT NULL,
     "employee_id" bigint,
     "working_month" varchar,
     "workingtimes" varchar,
     "creator" varchar DEFAULT '',
     "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
     "updater" varchar DEFAULT '',
     "update_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
